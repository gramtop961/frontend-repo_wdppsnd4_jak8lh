...
const perks = [
  ...
  'Feature on official Infinity Society page'
];
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
          {prizes.map((p, i) => (
            ...
            >
              ...
              <p className="relative mt-2 text-sm text-white/80">{p.reward}</p>
              <motion.div
                whileHover={{ scale: 1.04 }}
                className="relative mt-5 inline-block rounded-full bg-white/5 px-5 py-2 text-sm text-white/80 ring-1 ring-white/10 transition-all duration-300 group-hover:bg-white/10"
              >
                View Details
              </motion.div>
        ...
        >
          ...
          <div className="relative flex items-start gap-3">
            ...
            <div>
              <div className="text-lg font-semibold">All finalists receive</div>
