...
const rules = [
  {
    title: 'Team Size: 2–4',
    desc: 'Each team must consist of 2–4 participants.',
    Icon: CheckCircle2,
    hue: '#00FFC6'
  },
  {
    title: 'Stick to Problem Statements',
    desc: 'Projects must strictly adhere to the problem statements provided at kickoff.',
    Icon: Wrench,
    hue: '#8A2BE2'
  },
  {
